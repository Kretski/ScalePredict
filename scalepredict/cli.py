...
scalepredict.cli
================
Command-line interface for ScalePredict W-Twin monitor.

Usage:
    scalepredict monitor training_log.csv
    scalepredict monitor training_log.csv --loss-col train_loss --step-col step
    scalepredict monitor training_log.csv --alpha 2.0 --warmup 100
    scalepredict demo
"""
...
def cmd_demo(args):
    ...
    import numpy as np
    from scalepredict.monitor import WTwinMonitor
    from scalepredict.monitor.benchmark import (
        generate_failure_run, generate_clean_run
    )

    print("\n  ScalePredict W-Twin — Quick Demo")
    print("  =================================")
    ...
    print("    scalepredict monitor your_log.csv")
    print()
...
def main():
    parser = argparse.ArgumentParser(
        prog="scalepredict",
        description="ScalePredict W-Twin — training degradation monitor",
    )
