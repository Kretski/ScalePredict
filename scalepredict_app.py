...
<div style='background:rgba(0,245,196,0.04); border:1px solid rgba(0,245,196,0.2);
     ...
     line-height:1.9'>
  🔒 <b style="color:#e8e8f0">Privacy — what is in the JSON file?</b><br>
  The profile contains: CPU model, RAM size, core count, benchmark results.<br>
  <b style="color:#e8e8f0">No usernames. No location. No personal data.</b><br>
  It is processed only in your browser session — not stored, not sent anywhere.<br>
  You can open the file in any text editor to verify before uploading.
</div>
""", unsafe_allow_html=True)
